...
<simconf version="2022112801">
  <simulation>
    ...
    <motetype>
      ...
      <description>p2p node</description>
      <source>[CONFIG_DIR]/p2pudp.c</source>
      <commands>make -j$(CPUS) p2pudp.cooja TARGET=cooja</commands>
      ...
      <mote>
        <interface_config>
          ...
          <pos x="33.351150777047664" y="8.557138242309016" />
        </interface_config>
        <interface_config>
      ...
      <mote>
        <interface_config>
          org.contikios.cooja.interfaces.Position
          <pos x="28.395765344132943" y="46.388779880281135" />
        </interface_config>
        <interface_config>
          org.contikios.cooja.contikimote.interfaces.ContikiMoteID
          <id>2</id>
      ...
      <mote>
        <interface_config>
          org.contikios.cooja.interfaces.Position
          <pos x="35.59548166020312" y="29.222595219763548" />
        </interface_config>
        <interface_config>
          org.contikios.cooja.contikimote.interfaces.ContikiMoteID
          <id>4</id>
  ...
  <plugin>
    ...
    <bounds x="0" y="1151" height="166" width="3228" z="3" />
  </plugin>
  <plugin>
    ...
    <bounds x="680" y="0" height="160" width="2548" z="2" />
  </plugin>
</simconf>
